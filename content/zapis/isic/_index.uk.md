...
Pre 100% zľavu z cestovného na vlaky si treba ísť nový preukaz zaregistrovať na železničnú stanicu, kde dostanete registračné číslo (za tento úkon sa účtuje malý poplatok) a preukaz. S týmto máte nárok na zľavu, vo vlaku sa stačí prezentovať revízorovi iba s ISICom a lístkom (preukaz vydaný v kancelárii ZSSK je teda užitočný iba preto, že má na sebe registračné číslo, ktoré potrebujete napríklad v aplikácii *Ideme vlakom*). Nárok na zľavu zaniká ukončením 2. stupňa VŠ alebo dovŕšením 26 rokov.

Od 1.8.2025 v regionálnych vlakoch (Os, REX) stačí na cestovanie platný ISIC preukaz s aktivovanou zľavou, cestovný lístok nie je potrebný. V diaľkových vlakoch (R, Ex, EC) lístok (aj keď zadarmo) zostáva povinný. 
